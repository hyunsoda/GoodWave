...
const showInsertComment = (originalCommentNo, btn) => {
  ...
  insertBtn.setAttribute("onclick", "insertChildComment("+originalCommentNo+", this)");
...
const insertChildComment = (originalCommentNo, btn) => {
    ...
    const data = {
      ...
      "originalCommentNo" : originalCommentNo 
    }; 
